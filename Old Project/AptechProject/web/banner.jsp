    ...
    <body>
        <div id="carousel-id" class="carousel slide" data-ride="carousel">
            ...
            <ul class="carousel-inner">
                <s:iterator value="lstBanner">                
                    <li class="item <s:property value="statusbanner"/>">
                    <div class="images-item">
                        <a href="getPro?productId=<s:property value="productId"/>"><img class="item-images img-responsive" src="<s:property value="linkbanner"/>"/></a>
                    </div>				
                </li>
                </s:iterator>
            </ul>
