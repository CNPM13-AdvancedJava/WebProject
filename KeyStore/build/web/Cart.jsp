        ...
        <div class="bgbody">
            ...
            <div class="content-giohang">
                <div class="container">
                    <div class="row">
                        <div class="giohang">
                            <span class="sotientt">Danh sách sản phẩm trong giỏ hàng : </span>
                                ...
                                <div class="col-lg-12 col-md-12 col-xs-12 content-thanhtoan">
                                    <div class="web-pay">
                                        ...
                                        <div id="pay-quavi" style="display:block;">                                                        
                                            <a href="DirectPayment" type="button" onclick="checkPay()" class="btn btn-danger">Thanh toán</a>
                                            <a href="Home.jsp" type="button" class="btn btn-danger">Huỷ bỏ</a>
                                        </div>
